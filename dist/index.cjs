...
function usePadVisual() {
  ...
  const spawn = (0, import_react11.useMemo)(
...
function PadGlCanvas({ containerRef }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("canvas", { ref: canvasRef, className: "chaospad-gl-canvas", "aria-hidden": "true" });
}
...
function ChaosPad({ className, style }) {
  ...
  const visualRef = (0, import_react13.useRef)(null);
  useAudioUnlock();
  useChaosAudio();
  useChaosWebSocket();

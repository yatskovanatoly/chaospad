...
function PadGlCanvas({ containerRef }) {
  ...
  const simRef = (0, import_react12.useRef)(null);
  const rafRef = (0, import_react12.useRef)(0);
...
function ChaosPad({ className, style }) {
  ...
  const surfaceRef = (0, import_react13.useRef)(null);
  const glowContainerRef = (0, import_react13.useRef)(null);
  useAudioUnlock();
  useChaosAudio();
  useChaosWebSocket();
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { ref: rootRef, className: rootClass, style, children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { ref: surfaceRef, className: "chaospad-surface", "aria-hidden": "true" }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { ref: glowContainerRef, className: "chaospad-glow-layer", children: visualMode === "webgl" && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(PadGlCanvas, { containerRef: glowContainerRef }) }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(GlowFx_default, { containerRef: glowContainerRef })
  ] });
}
...
var WebSocketProvider = ({ children }) => {
  ...
  const [pos, setPos] = (0, import_react14.useState)(void 0);
  const [type, setType] = (0, import_react14.useState)("stop");
  const wsRef = (0, import_react14.useRef)(null);
  const userIdRef = (0, import_react14.useRef)(configUserId != null ? configUserId : getUserId());
  const userId = userIdRef.current;
  const color = getColorForUser(userId) || colors[0];
  const [message, setMessage] = (0, import_react14.useState)(void 0);
  const messageSeqRef = (0, import_react14.useRef)(0);
  const typeRef = (0, import_react14.useRef)(type);
  const posRef = (0, import_react14.useRef)(pos);
  const colorRef = (0, import_react14.useRef)(color);
  typeRef.current = type;
  posRef.current = pos;
  colorRef.current = color;
  const motionListenersRef = (0, import_react14.useRef)(/* @__PURE__ */ new Set());
  const pendingPayloadRef = (0, import_react14.useRef)(null);
  const sendNow = () => {
  ...
  const sendNowRef = (0, import_react14.useRef)(sendNow);
  sendNowRef.current = sendNow;
  const emitMotion = (0, import_react14.useCallback)((nextPos, nextType) => {
  ...
  const subscribeMotion = (0, import_react14.useCallback)((listener) => {
...
function Chaospad({ config, className, style }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ChaospadConfigProvider, { config, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(WsContextProvider_default, { children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(AudioEngineProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ChaosPad, { className, style }) }) }) });
}
